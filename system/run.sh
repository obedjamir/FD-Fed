nohup python3 main.py -algo OursGCAM -lr 0.01 -al 0.001 -m effnet -mn effnet -lam 0.35 -th 2 -nc 3 -data nihchestxray -t 5 -go experiment -gpu 0 > OursGCAM_nihchestxray_3_effnet.log 2>&1 &
wait
...
wait
nohup python3 main.py -algo OursGCAM -lr 0.01 -al 0.005 -m mobilenet -mn mobilenet -lam 0.28 -th 3 -nc 5 -data cifar10 -t 5 -go experiment -gpu 0 > OursGCAM_cifar10_5_mobilenet.log 2>&1 &
wait
