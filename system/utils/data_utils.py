...
def read_client_data(
    ...
    # ---------------- Train subset (percentage-based) ----------------
    if data_split == 'train':
        return (
            [(x, label_map[y]) for x, y in zip(X_train, y_train)],
    ...
    # ---------------- Validation ----------------
        ...
        return (
            [(x, label_map[y]) for x, y in zip(X_val, y_val)],
            unique_labels
        )
    ...
    # ---------------- Test ----------------
        ...
        return (
            [(x, label_map[y]) for x, y in zip(X_test, y_test)],
            unique_labels
        )
